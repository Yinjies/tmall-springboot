 ...
 * @description: 对Page 类进行了封装
 * 构造方法里提供了一个 navigatePages 参数
 * 构造方法里，还调用了 calcNavigatepageNums， 就是用来计算这个数值，并返回到一个int 数组变量 navigatepageNums ，方便前端遍历展示
 * @author: Yin jie
 * @create: 2020-04-09 09:49
 **/
